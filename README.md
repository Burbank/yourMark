...
**[Download yourMark-0.3.41.dmg](https://github.com/Burbank/yourMark/releases/latest/download/yourMark-0.3.41.dmg)** · [All versions](https://github.com/Burbank/yourMark/releases) · [Install notes](INSTALL.md) · [Test a simpler version in your browser](https://burbank.github.io/yourMark/) (preview only — no OCR)
